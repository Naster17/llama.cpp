...
extern "C" {
    ...
    */
    ...
    GGML_API int                  ggml_backend_sched_get_n_graph_inputs(ggml_backend_sched_t sched);
    GGML_API struct ggml_tensor * ggml_backend_sched_get_graph_input(ggml_backend_sched_t sched, int i);
